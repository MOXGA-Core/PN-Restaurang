                    ...
                    <div class="single-menu-details">
                        ...
                        <div class="single-menu-content">
                            <div class="menu-title">
                                <h4>Steak Marinade (Price: $9.99*)</h4>
                            </div>


                            <div class="text-desc text-center mt-5 mb-50">
                                <p class="lh30">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.
                            ...
                            <div class="row">
                                <div class="col-sm-4">
                                    <div class="ingredient-item check-type-list">
                                        <h5 class="title">Nutritional Value (Minerals) </h5>
                                        <ul class="ingredient-list">
                                            <li><span class="icon">&#10004;</span>Potassium - 393 mg</li>
                                            <li><span class="icon">&#10004;</span>Potassium - 393 mg</li>
                                            <li><span class="icon">&#10004;</span>Potassium - 393 mg</li>
                                            <li><span class="icon">&#10004;</span>Potassium - 393 mg</li>
                                            <li><span class="icon">&#10004;</span>Potassium - 393 mg</li>
                                        </ul>
                                    </div><!--ingredient-item check-list-->
                                </div><!--col-sm-4-->
                                <div class="col-sm-4">
                                    <div class="ingredient-item check-type-list">
                                        <h5 class="title">Nutritional Value (Vitamins) </h5>
                                        <ul class="ingredient-list">
                                            <li><span class="icon">&#10004;</span>Potassium - 393 mg</li>
                                            <li><span class="icon">&#10004;</span>Potassium - 393 mg</li>
                                            <li><span class="icon">&#10004;</span>Potassium - 393 mg</li>
                                ...
                                <div class="col-sm-4">
                                    <div class="ingredient-item check-type-list">
                                        <h5 class="title">Ingredients of Steak</h5>
                                        <ul class="ingredient-list">
                                            <li><span class="icon">&#9632;</span>Potassium - 393 mg</li>
                                            <li><span class="icon">&#9632;</span>Potassium - 393 mg</li>
                                            <li><span class="icon">&#9632;</span>Potassium - 393 mg</li>
                            ...
                            <div class="mt-55">
                                <h3 class="title-md mb-30">Related Food:</h3>
                                <div class="row">
                                    <!--                            <div class="col-sm-12">-->

...
<div class="section-wrapper">
    ...
    <section class="page-banner">
        ...
        <div class="container">
            <div class="section-heading text-center">
                <h1 class="section-title-big"><span class="colored">Breakfast</span></h1>
                <div class="divider">
    ...
    <section class="section-menu bg-gray pt-120 pb-120 relative">
        ...
        <!--PARALLEX IMAGES-->
        <div class="parallex right para1" style="background:url(assets/img/para1.png) no-repeat;" data-0="background-position:100% 0px;" data-end="background-position:100% 600px;"></div>

        <div class="parallex left para2" style="background:url(assets/img/para2.png) no-repeat;" data-0="background-position:0px 0px;" data-end="background-position:0px 600px;"></div>
                            ...
                            <div class="food-menu-title">
                                ...
                                <div class="layer">
                                    <div class="content">
                                        ...
                                        <h5>Breakfast</h5>
                                        <div class="time-phrase">Time: 15.30 - 22.30</div>
                                    </div><!--content-->
                                </div><!--layer-->
                            </div><!--food-menu-type-->
                            <!-- Food menu content -->

                ...
                <div class="col-sm-8 col-sm-offset-2">
                    ...
                    <div class="contact-form-wrap">
                        <form class="reservation-form img-icon-input">
                            ...
                            <div class="col-md-6">
                                <div class="input-group ">
                                    <!--                                <input type="text" class="form-control" name="number-people" placeholder="No of people">-->
                                    <select name="number-people"  class="form-control">
                            ...
                            <div class="col-md-6">
                                <div class="input-group ">
                                    <!--                                <input type="text" class="form-control" name="barnch" placeholder="Restaurant branch">-->
                                    <select name="barnch"  class="form-control">
                            ...
                            <div class="col-md-12">
                                <div class="input-group">
                                    ...
                                    <span class="icon"><img src="assets/img/envelope.png" alt="Image"></span>
                                </div><!-- /input-group -->
                                <div class="text-center">
                                    <button type="submit" class="btn-primary btn-submit">Find a Table</button>
                                </div>
                            </div>
                        </form><!-- .comment-form -->
